 ...
 private    Button login;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        regText.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(CaregiverLoginActivity.this, CaregiverRegisterActivity.class);
    ...
    private void caregiverLogin(){
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST,
                URLs.URL_LOGIN_CAREGIVER, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (obj.getString("status")!="-1"){
                        ...
                        Toast.makeText(CaregiverLoginActivity.this,
                                "Welcome", Toast.LENGTH_SHORT).show();

                        JSONObject userJson = obj.getJSONObject("data");

                      Caregiver caregiver = new Caregiver(userJson.getInt("id"));

                        SessionManagerCaregiver.getInstance(CaregiverLoginActivity.this).userLogin(caregiver);
                        Intent intent = new Intent(CaregiverLoginActivity.this,CaregiverMainActivity.class);
                        startActivity(intent);
                    } else {
                        Toast.makeText(CaregiverLoginActivity.this,
        ...
        VolleySingleton.getInstance(CaregiverLoginActivity.this).addToRequestQueue(stringRequest);
